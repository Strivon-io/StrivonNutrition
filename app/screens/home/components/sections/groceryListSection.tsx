...
import { ShoppingList } from "~services/types/recipe.types";
...
export const GroceryListSection: FC<{ shoppingList: ShoppingList }> = ({
  ...
  const initialGroceryList = [
    { id: 1, item: "Chicken", isChecked: false },
    { id: 2, item: "Lettuce", isChecked: true },
    { id: 3, item: "Tomatoes", isChecked: false },
  ];
