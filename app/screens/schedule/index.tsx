...
type RecipesScreenProps = NativeStackScreenProps<BottomTabParamList, 'schedule'>
...
export const ScheduleScreen: FC<RecipesScreenProps> = ({ navigation }) => {
  ...
  const recipesByDate = useMemo(() => groupRecipesByDate(ProgrammedRecipes), [
    ProgrammedRecipes,
  ])

  const uniqueDates = useMemo(() => Object.keys(recipesByDate), [recipesByDate])
